...
},{"./barchart.js":2,"./d3-chart-shim.js":5,"./d3-shim":6,"jquery-browserify":7}],2:[function(require,module,exports){
/**
...
d3.chart('BarChart', {
	initialize: function(config) {
		...
		chart.y = d3.scale.linear().range([chart.h - chart.margins.bottom, 0]);
		...
		// -- areas
		chart.areas.ylabels = chart.base.append('g').classed('ylabels', true).attr('width', chart.margins.left).attr('height', chart.h - chart.margins.bottom - chart.margins.top).attr('transform', 'translate(' + (chart.margins.left - 1) + ',0)');

		chart.areas.bars = chart.base.append('g').classed('bars', true).attr('width', chart.w - chart.margins.left).attr('height', chart.h - chart.margins.bottom - chart.margins.top).attr('transform', 'translate(' + chart.margins.left + ',' + chart.margins.top + ')');

		chart.areas.xlabels = chart.base.append('g').classed('xlabels', true).attr('width', chart.w - chart.margins.left).attr('height', chart.margins.bottom).attr('transform', 'translate(' + chart.margins.left + ',' + (chart.h - chart.margins.bottom) + ')');
		...
		chart.layer('xlabels', chart.areas.xlabels, {
			dataBind: function(data) {
				...
				this.append('line').attr('x1', 0).attr('x2', chart.w - chart.margins.left).attr('y1', 0).attr('y2', 0).style('stroke', '#222').style('stroke-width', '1').style('shape-rendering', 'crispEdges');

				return this.selectAll('text').data(data);
			},
			insert: function() {
				return this.append('text').classed('label', true) //.attr('text-anchor', 'middle').attr('x', function(d, i) {
		...
		var onXEnter = function() {
			this.style("text-anchor", "end")
				.attr({
		...
		chart.layer('bars').on('update', onUpdate);
	},
	...
	width: function(newWidth) {
		...
		this.x = d3.scale.linear().range([this.margins.left, this.w - this.margins.right]);
	...
	height: function(newHeight) {
		...
		// adjust the y scale
		this.y = d3.scale.linear().range([this.h - this.margins.top, this.margins.bottom]);
...
},{"./d3-shim":6}],3:[function(require,module,exports){
/*! d3.chart - v0.1.3
 *  License: MIT Expat
 *  Date: 2013-10-07
 */
...
var d3 = window.d3 = require('../../d3-shim.js');
//var d3 = require('../../d3-shim.js');
...
},{"../../d3-shim.js":6}],4:[function(require,module,exports){
d3 = function() {
  var d3 = {
    version: "3.3.9"
  };
...
//var d3 = require('./d3-shim');
require("./bower_components/d3.chart/d3.chart.js");
module.exports = window.d3.chart;


},{"./bower_components/d3.chart/d3.chart.js":3}],6:[function(require,module,exports){
require("./bower_components/d3/d3.js");
module.exports = window.d3;
},{"./bower_components/d3/d3.js":4}],7:[function(require,module,exports){
